export default {
    name: 'accountsnFilingPage',
    title: 'Accounts & Filing Page',
    type: 'document',
    fields: [
      {
        name: 'title',
        title: 'Page Title',
        type: 'string',
        description: 'Main title for the Accounts & Filing page',
      ...
      },
      {
        ...
        title: 'Page Subtitle',
        type: 'string',
        description: 'Subtitle or tagline for the Accounts & Filing page'
      },
      {
    ...
    preview: {
      ...
      prepare({ title }) {
        return {
          title: title || 'Accounts & Filing Page'
        }
      }
    }
  }
